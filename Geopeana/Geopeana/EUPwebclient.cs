    ...
    public class EUPwebclient
    {
        ...
        public void lookup(string keyword)
        {
            if (SearchFilter.country == "All Europe")
            {
                ...
                query = "http://api.europeana.eu/api/opensearch.rss?searchTerms=" + keyword +timeelement+ "+AND+europeana_type:*IMAGE*&wskey=" + Europeana_API_key;
        ...
        public void lookup(string keyword, string country)
        {
            ...
            query = "http://api.europeana.eu/api/opensearch.rss?searchTerms=" + keyword + timeelement + "+AND+europeana_type:*IMAGE*+AND+enrichment_place_broader_label%3A" + country.ToLower() + "&wskey=" + Europeana_API_key;
